...
public class RetrofitException extends RuntimeException {
     ...
     * response.
     *
     * @throws {@link java.io.IOException} if unable to convert the body to the specified {@code type}.
     */
    public <T> T getErrorBodyAs(Class<T> type) throws IOException {
        ...
        Converter<ResponseBody, T> converter = retrofit.responseBodyConverter(type, annotations);
